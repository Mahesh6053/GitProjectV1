...
public class SerializationRestAssured extends BaseClassForCreationBookings{
	...
	public void createBookingWithPOJOTest() {
		...
		Bookingserialization booking = new Bookingserialization("Mahesh", "Amisagadda", 200, false, bookingdates, "Baby crib");
