...
public class Bookingserialization {
	...
	public Bookingserialization(String firstname, String lastname, int totalprice, boolean depositpaid, Bookingdates bookingdates, String additionalneeds) {
