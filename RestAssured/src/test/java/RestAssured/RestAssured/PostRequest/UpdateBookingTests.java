...
public class UpdateBookingTests extends BaseClassForCreationBookings {
	...
	public void updateBookingTest() {
		...
		body.put("firstname", "Harish");
		body.put("lastname", "babu");
		...
		softAssert.assertEquals(actualFirstName, "Harish", "firstname in response is not expected");

		String actualLastName = responseUpdate.jsonPath().getString("lastname");
		softAssert.assertEquals(actualLastName, "babu", "lastname in response is not expected");
